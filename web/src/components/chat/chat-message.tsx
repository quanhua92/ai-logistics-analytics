  ...
  if (message.role === "user") {
    return (
      <div className="flex justify-end">
        <div className="max-w-[85%] whitespace-pre-wrap rounded-2xl rounded-tr-sm bg-primary px-3.5 py-2 text-sm text-primary-foreground">
          {message.content}
        </div>
      </div>
    );
    ...
    <div className="flex justify-start">
      <div className="min-w-0 flex-1 space-y-2">
        ...
        {message.error ? (
          ...
          <div className="prose-chat max-w-full rounded-2xl rounded-tl-sm border bg-card px-3.5 py-2.5 text-sm leading-relaxed shadow-card">
            <ReactMarkdown
